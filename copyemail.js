let mailData = {
  name: 'Apple Mail',
  mailboxes: {
    drafts: [{subject: 'Resignation Notice', message: 'I hate this job. Peace.'},
    ...
    sent: [{subject: 'Thank You Letter', message: 'Thank you for inviting me to interview for your company. I enjoyed my time and I hope you did as well.'},
    {subject: 'Urgent - Please Review', message: 'Please review the email previously sent. Thanks.'}],
    junk: [{subject: 'Click here to claim your prize!', message: 'I am a Nigerian prince who recently got a lot of money. Send me your bank information so I can wire $1,000,000 to you.'}],
    trash: [{subject: 'Job Interview Results', message: 'We would like to regretfully inform you that you were not chosen for the position.'},
